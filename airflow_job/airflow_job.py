...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-gds-dev-07")
    bq_project = Variable.get("bq_project", default_var="useful-mile-470006-v3")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "505775996251-compute@developer.gserviceaccount.com",
